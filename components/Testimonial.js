        ...
        <div className="flex pt-2 pl-2 w-full sm:w-3/5 lg:w-2/5 mt-5 sm:mt-10 md:mt-16 rounded-3xl mx-auto bg-gradient-to-br from-[#50d89f]  to-[#6a7eda] hover:shadow-md">
          <div className="flex flex-col w-full sm:w-full bg-slate-100 bg-opacity-60 rounded-3xl mx-auto items-center justify-center">
            ...
            <p className="mt-5 mx-8 text-s sm:text-lg text-center">
              Hilman worked as an intern in the BPS Department at Bosch. He works well independently to solve problems and accomplish task assigned. He also helped the PGP2 team by automating report generation and distribution, saving employees time on monthly reports. I&apos;m confident that with the right guidance, he will be a successful person in the future.
            </p>
            <img
